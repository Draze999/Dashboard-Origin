export const ARMES = ["Epee Longue","Espadon","Epees Doubles","Gantelets","Nunchaku","Hache","Lance","Rapière","Epee & Bouclier","Grimoire","Baguette","Bâton"] as const;
export const ELEMENTS = ["Physique","Feu","Glace","Vent","Terre","Foudre","Ténèbres","Sacré"] as const;
...
export const DIFFICULTES_DONJON = ["Facile","Normal","Difficile","Cauchemar","Infernal","Abysse","Transcendance","Jonction Bleue","Jonction Violette"] as const;

export type Personnage = {
  id: string; personnage: string; rarete: typeof RARETES[number]; arme: typeof ARMES[number];
  element: typeof ELEMENTS[number]; type_personnage: typeof TYPES_PERSONNAGE[number];
  histoire: typeof HISTOIRES[number]; image_url: string | null; created_at: string; updated_at: string;
};
export type Donjon = {
